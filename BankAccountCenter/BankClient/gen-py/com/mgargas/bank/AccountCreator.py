...
class Iface:
  def registerClient(self, data, initialBalance):
    """
    Parameters:
     - data
     - initialBalance
...
class Client(Iface):
  ...
  def registerClient(self, data, initialBalance):
    ...
    Parameters:
     ...
     - initialBalance
    """
    self.send_registerClient(data, initialBalance)
    return self.recv_registerClient()

  def send_registerClient(self, data, initialBalance):
...
class Processor(Iface, TProcessor):
  ...
  def process_registerClient(self, seqid, iprot, oprot):
    ...
    result = registerClient_result()
    try:
      result.success = self._handler.registerClient(args.data, args.initialBalance)
...
class registerClient_args:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'initialBalance', (Money, Money.thrift_spec), None, ), # 2
  )

  def __init__(self, data=None, initialBalance=None,):
    self.data = data
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.initialBalance = Money()
          self.initialBalance.read(iprot)
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.initialBalance is not None:
      oprot.writeFieldBegin('initialBalance', TType.STRUCT, 2)
      self.initialBalance.write(oprot)
      oprot.writeFieldEnd()
...
class registerClient_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (BankClient, BankClient.thrift_spec), None, ), # 0
